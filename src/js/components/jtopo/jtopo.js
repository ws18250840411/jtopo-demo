!function (window) {
    ...
    CanvasRenderingContext2D.prototype.JTopoTrapezoid = function (a, b, c, d, e) {
        ...
        CanvasRenderingContext2D.prototype.JTopoRoundRect = function (a, b, c, d, e) {
            "undefined" == typeof e && (e = 5),
                this.beginPath(), this.moveTo(a + e, b),
                this.lineTo(a + c - e, b),
    ...
    function f(b, c, g) {
        ...
        this.initialize = function (b, c, d) {
            ...
            if (null != this.arrowType && 'circle' === this.arrowType) {
                ...
                a.fillStyle = "rgba(" + this.strokeColor + "," + this.alpha + ")";
                a.moveTo(b[0].x + 2 * this.arrowsRadius, b[0].y);
                a.strokeRect(b[0].x+ 0.5*this.arrowsRadius, b[0].y - 0.75 * this.arrowsRadius, 1.5 * this.arrowsRadius, 1.5 * this.arrowsRadius);
            } else {
                a.beginPath();
            ...
            if (null != this.arrowType && 'circle' === this.arrowType) {
                ...
                b.fillRect(o.x, o.y + f - this.arrowsRadius, 2 * this.arrowsRadius, 2 * this.arrowsRadius),
                    b.stroke(),
                    b.closePath()
            } else {
                //画箭头部分
    ...
    function b(c) {
        this.initialize = function (c) {
            ...
            this.visible && (this.layout && this.layout(this, this.childs),
                ...
                null == this.borderRadius || 0 == this.borderRadius ? a.JTopoTrapezoid(this.x, this.y, this.width, this.height, this.TrapezoidTopLeftPadding,this.TrapezoidTopRightPadding) : a.JTopoRoundRect(this.x, this.y, this.width, this.height, this.borderRadius),
